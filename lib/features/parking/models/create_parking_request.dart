/// Create Parking Request Model
/// Request body for creating a parking lot
class CreateParkingRequest {
  ...
  /// Create a copy of CreateParkingRequest with updated fields
  CreateParkingRequest copyWith({
    String? lotName,
    String? address,
    double? latitude,
    double? longitude,
